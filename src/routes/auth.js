...
router.get("/me", async (req, res) => {
  // Prevent 304/stale cache and make responses vary by cookie
...
router.post("/change-password", async (req, res) => {
  try {
    ...
    signAccessCookie(res, { uid: String(u._id), email: u.email, role: u.role }, "7d");
...
/** Logout (clear cookie with matching attrs) */
